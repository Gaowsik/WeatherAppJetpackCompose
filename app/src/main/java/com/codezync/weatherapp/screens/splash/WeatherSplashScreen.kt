package com.codezync.weatherapp.screens.splash
...
fun WeatherSplashScreen(navController: NavController) {
    //scale help to control the state of animation
    val scale = remember {
        Animatable(0f)
    }
    ...
    LaunchedEffect(key1 = true, block = {
        ...
        delay(2000L)
        navController.navigate(WeatherScreens.MainScreen.name+"/madrid")
    })
